...
GEM_NAME          = "rb-skypemac" # what ppl will type to install your gem
...
VERS      = SkypeMac::VERSION::STRING + (REV ? ".#{REV}" : "")
RDOC_OPTS = [
    "--quiet",
    "--title", "rb-skypemac documentation",
    "--opname", "index.html",
    "--line-numbers",
    "--main", "README",
    "--inline-source"
...
hoe = Hoe.new(GEM_NAME, VERS) do |p|
  ...
  p.extra_deps = [ ["rb-appscript", ">=0.3.0"] ]
